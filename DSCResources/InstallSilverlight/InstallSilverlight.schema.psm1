...
### The InstallSilverlight DSC Resource is implemented as a "composite" DSC Resource, which is
### a DSC Configuration Document comprised of other DSC Resource instances. Consequently,
### the InstallSilverlight DSC Resource does not implement its own Get, Test, and Set methods.

Configuration InstallSilverlight
{
