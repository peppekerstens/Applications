...
### The InstallCutePDF DSC Resource is implemented as a "composite" DSC Resource, which is
### a DSC Configuration Document comprised of other DSC Resource instances. Consequently,
### the InstallCutePDF DSC Resource does not implement its own Get, Test, and Set methods.
...
<#
    ...
    Registry AllowWebcam32
    {
        ...
        ValueData = 0
        ValueType = 'Dword'
        DependsOn = '[OneGetPackage]CutePDF'
    }
